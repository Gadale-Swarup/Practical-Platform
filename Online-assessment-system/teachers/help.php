    ...
    <div class="home-content">
      ...
      <div class="stat-boxes">
        <div class="recent-stat box" style="width:100%">
          ...
          <h4>Q4. How to upload studet data ?</h4>
          <p>Ans: Click on the upload option from the left navigation bar. The list of all the students will be displayed there. To add a Excel files, click on choose file button and select the excel file that you want to upload and then click on the upload button.</p><br>
          <h4>Q5. How to view the results ?</h4>
          <p>Ans: Go to the results option from the left navigation bar to view the results. </p><br>
          <h4>Q6. How to conduct exams ?</h4>
