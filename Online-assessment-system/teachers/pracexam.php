      ...
      <div class="stat-boxes" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="delprac.php" method="post">
                                        ...
                                        <button type="submit" name="delete_btn1" class="rounded-button-del"><i class='bx bx-x'></i></button>
                                    </form>
                                </td>
                            </tr>
                        <?php
        ...
        <div class="top-stat box">
          ...
          <br><br>
              ...
              <br><br>             
              <button type="submit" name="addprac" class="btn"><i class='bx bx-plus' ></i> Add</button>    
          </form>
        </div>
      </div>
